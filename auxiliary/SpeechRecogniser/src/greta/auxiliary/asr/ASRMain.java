...
public class ASRMain {
    	...
    	private ActiveMQConnecor activeMQConnection = null;
	...
	public void setResponseTopic(String responseTopic) {
        ...
        public ASRMain(){
            activeMQConnection = new ActiveMQConnecor();
            sr = new SpeechRecogniser();
        ...
        public ActiveMQConnecor getActiveMQConnector(){
