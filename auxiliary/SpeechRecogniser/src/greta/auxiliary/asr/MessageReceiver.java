...
public class MessageReceiver extends Receiver<String> {
	...
	private List<SpeechRecogniserListener> listeners;
	private boolean active;
	
    public MessageReceiver(String host, String port, String topic){
        super(host, port, topic);
        this.listeners = new ArrayList<SpeechRecogniserListener>();
        this.active = true;
    }
    ...
    protected void onConnectionStarted() {
    	...
    	for (SpeechRecogniserListener listener : this.listeners) {
	...
	public List<SpeechRecogniserListener> getListeners() {
