...
public class SpeechRecogniserFrame extends JFrame implements SpeechRecogniserListener {
	...
	private ActiveMQConnecor groupBehaviorMain = null;
	 private SpeechRecogniser sr = null;
	public SpeechRecogniserFrame() {
		this.initComponents();
	}
	...
	private void initComponents() {
		...
		this.resetConnectionButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				SpeechRecogniserFrame.this.establishActiveMqConnection();
			}
	...
	private void establishActiveMqConnection() {
		...
		this.asrMain.getActiveMQConnector().registerAsGroupBehaviorReceiverListener(this);
		this.setConnectionLabel(false);
